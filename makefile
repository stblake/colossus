...
test:
	...
	./tests/test_enigma
	$(CC) $(INCLUDES) tests/test_chaocipher.c $(CORE)/utils.c $(MACHINE)/chaocipher.c -o tests/test_chaocipher
	./tests/test_chaocipher
...
testopt:
	...
	$(CC) $(INCLUDES) -DCOLOSSUS_NO_MAIN tests/test_chaocipher_solver.c $(SOLVER_SRC) -o tests/test_chaocipher_solver
	./tests/test_chaocipher_solver
